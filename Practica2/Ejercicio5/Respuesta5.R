...
# Item b)
my.while.function <- function(unacadena){ # Recibe una cadena de caracteres
...
my.while.function("R fever") # El resultado es "R fev"
my.while.function("Chapter") # El resultado es "Chapter"
my.while.function("elEphant") # El resultado es "el"